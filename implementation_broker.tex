...
\begin{description}
    \item[.index] Containing a sequence of index entries as binary data
    \item[.log] Containing a sequence of log entries as binary data
\end{description}
...
offset} is the offset of the first log entry stored in this file. For example if
a log holds messages whereas the first message has the offset \textit{5 ::
Int64} the file
