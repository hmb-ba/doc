...
First of all, the structure of the messages within the index file describes
only 2 fields, each of them 32 bit long:

\begin{itemize}
  \item 4 Bytes: Relative Offset
  \item 4 Bytes: Physical Position
\end{itemize}
