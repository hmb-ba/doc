...
\begin{lstlisting}[caption={Init client connection to broker}]
...
\begin{lstlisting}[caption={Read meta information from client input}]
...
\begin{lstlisting}[caption={Publish each console input as single request to the broker}]
  forever $  do 
