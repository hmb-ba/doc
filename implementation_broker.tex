...
A sequence of MessageSets is a special case where the protocol does not provide a
field which determines the number of elements. The is just a field which contains
...
module and was separated just for clarity. Thus we also rely on Data.Binary and use the
