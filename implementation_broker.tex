...
the next step leads to determine the offset entry which is the closest to the
effectively wanted offset. Therefore, the map containing the topic and partition
related index is being searched.
...
or the page is not already in memory. This comes very handy in terms of
...
is the beginning byte of the file region and the size tells the mapping length.
