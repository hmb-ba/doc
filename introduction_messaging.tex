...
needs to communicate with. When a target address changes, all the systems that
...
to be made on every node, which leads to duplicating code. Therefore, a more
centralised solution is required in more complex integration solutions. This is
where the message broker comes into game.
