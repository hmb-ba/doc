...
The first result of this thesis is the prestudy documentation, which results in
gathered knowledge that is further being required for this thesis.  It gives an
...
Kafka compatible as it is based on the protocol implementation.
