...
structure to binary format and backwards. As decided in \ref{sic:seperation}, we
...
Offset      & Determines log offset number in log.  When the producer is sending
messages it doesn't actually know the offset and can fill in any value here it
likes. & Data.Word64 \\
MessageSize & MessageSets are not preceded by an int32 like other array elements
in the protocol. Instead, a MessageSet is defined by its Size in Bytes.
& Data.Word32
\end{tabular}
\end{table}
