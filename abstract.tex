\begin{abstract}
  ...
  Nowadays one can speak as of an ongoing revolution in web systems which turns
  previous demands upside down. Internet companies created a need for activity
  data, in an extremely high volume, which has never been existed before.  And
  the trend holds on -- not only companies with its core business in the cloud
  are creating a huge amount of data, more and more companies with a traditional
  fashioned core business are tending to create amounts of data, which will
  sooner or later surmount the yet so overwhelming data volumes of the internet
  big five (Apple, Microsoft, Google, Amazon, Facebook). The data those
  companies generate capture user and server activity. This data is at the heart
  of many internet systems in the domains of advertising, relevance, search,
  recommendation systems, and security, as well as continuing to fulfill its
  ...
  as the only way to produced valuable information -- real-time processing
  dominates the field now, where information is available as soon as data was
  ...
  .... now what what our thesis is about
